...
export const routes: Routes = [
  ...
  {
    path: 'categorie',
    loadComponent: () => import('./pages/categorie/categorie.page').then( m => m.CategoriePage)
  },
  ...
  {
    path: 'topsong',
    loadComponent: () => import('./pages/topsong/topsong.page').then( m => m.TopsongPage)
  },
  {
    path: 'topartist',
    loadComponent: () => import('./pages/topartist/topartist.page').then( m => m.TopartistPage)
  },
  {
    path: 'topalbum',
